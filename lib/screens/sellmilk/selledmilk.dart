...
class SelledMilk extends StatelessWidget {
  SelledMilk({Key? key}) : super(key: key);
        ...
        children: [
                      ...
                      SfDateRangePicker(
                        ...
                        onSubmit: (p0) {
                          if (selectedDates.isNotEmpty) {
                            showLoader(context);
                            _milkController
                                .getMilkToCustomersRange(selectedDates);
                            Get.back();
                          } else {
                            Get.defaultDialog(
                                content: const Text(
          ...
          Expanded(
            child: Container(
              ...
              child: Obx(
                () => ListView.builder(
                  itemCount: _milkController.milk.customers.length,
                  itemBuilder: (BuildContext context, int index) {
                    var adMilk = _milkController.milk.customers[index];
  ...
  double getTotalMilk() {
    double totolMilk = 0;
    for (var element in _milkController.milk.customers) {
