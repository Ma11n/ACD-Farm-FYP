...
class ReceptScreenCustomer extends StatelessWidget {
  final CurrentUserController _userController =
      Get.put(CurrentUserController());

  ReceptScreenCustomer(
      {Key? key, required this.totalMilk, required this.totalPrice})
      : super(key: key);
              ...
              Screenshot(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      (_userController.user.profilePic.value == '')
                          ? Container(
                              height: 100.h,
                              width: 100.w,
                              decoration: BoxDecoration(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Obx(
                            () => Text(_userController.user.name.value,
                                style: TextStyle(fontSize: 18.sp)),
                          ),
                        ],
                      ),
  ...
  saveImage(Uint8List image) async {
    ...
    final result = await ImageGallerySaver.saveImage(image,
        name: "${_userController.user.name.value} $getCurrrentDate()");
